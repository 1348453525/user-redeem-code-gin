...
func buildUserInfoDvo(user *model.User) entity.UserInfoDvo {
	return entity.UserInfoDvo{
		ID:       user.ID,
...
func (l *UserLogic) Register(c *gin.Context, r *entity.RegisterDto) (*entity.UserInfoDvo, error) {
	// 验证密码是否一致
